<div class="row">
  <div class="col-lg-12">
    <h1 class="page-header"><i class="fa fa-users"></i> Chart of Accounts list</h1>
  </div>
</div>
<div class="row">
  <div class="col-lg-12">
                ...
                <tr class="gradeX">
                  ...
                  <td>
                    ...
                    <?php if ($res['is_deletable']) { ?>
                      <button type="button" class="btn btn-sm btn-primary" name="admin_account_delete" value="<?= $res['id'] ?>"> Delete <i class="fa fa-trash"></i> </button>
                    <?php } else { ?>
